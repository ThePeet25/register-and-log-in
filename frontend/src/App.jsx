...
const App = () => {
  ...
  return (
    <div className="bg-neutral-800 min-h-screen flex justify-center items-center">
      <div className="container max-w-96 mx-auto p-6 flex flex-col justify-center items-center space-y-10 bg-white rounded-2xl shadow-lg shadow-white">  
        ...
        <button className="w-3/4 bg-neutral-800 text-white rounded-2xl px-a3 py-2 font-bold text-md transition-all active:bg-white active:text-neutral-800 active:border-2 active:border-neutral-800">Login</button>
